...
const FontConverterPage: React.FunctionComponent = () => {
	...
	return (
		<Layout
			current="Font Converter"
			title="FONT CONVERTER | DVLP HAUS | toolbox for developers"
		>
				...
				<div className="font__converter grid grid-2">
					...
					<div className="input_field">
						<div className="btn-settings">
							<Clipboard
								className="clipboard__btn"
								data-clipboard-text={`${multiply}em`}
							>
								Copy
							</Clipboard>
						</div>
					...
					<div className="input_field">
						<div className="btn-settings">
							<Clipboard
								className="clipboard__btn"
								data-clipboard-text={`${multiply}rem`}
							>
								Copy
							</Clipboard>
						</div>
					...
					<div className="input_field">
						<div className="btn-settings">
							<Clipboard
								className="clipboard__btn"
								data-clipboard-text={`${multiply}${ext}`}
							>
								Copy
							</Clipboard>
						</div>
